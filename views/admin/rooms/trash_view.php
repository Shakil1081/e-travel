...
$someData = $rooms->trashedPaginator($page,$itemsPerPage);
                                ...
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    foreach($someData as $oneData){
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo $oneData->room_number;?></td>
                                            <td class=" "><?php echo $oneData->room_capability;?></td>
                                            <td class=" "><?php echo $oneData->room_price;?></td>
                                            <td class=" "><?php echo $oneData->room_details;?></td>
                                            <td class=" "><?php echo $oneData->time_of_adding;?></td>
