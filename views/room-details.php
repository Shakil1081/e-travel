                ...
                <div class="container">
                    <div class="row">
                        <div class="tsp-title col-md-6 col-sm-6 col-xs-12 tsp-no-padding-left">
                            <h1><span>Hotel <?php echo $single_room->hotel_name ?></span></h1>
                            <div class="tsp-description">
								<p><i class="fa fa-map-marker"></i> <?php echo $single_room->hotel_location; ?></p>
								<p><i class="fa fa-phone"></i> <?php echo $single_room->room_capability; ?></p>
								<p><i class="fa fa-envelope"></i> <?php echo $single_room->room_category; ?></p>
                        ...
                        <!--<div class="tsp-breadcumb tsp-breadcrumb-description col-md-6 col-sm-6 col-xs-12 tsp-no-padding-right">
                            <ul>
                                ...
                                <li>/</li>
                                <li><a href="hotel-detail.html#">Rooms</a></li>
                                <li>/</li>
		...
		<div class="row">
			<div class="tsp-box-slideshow">
				<ul class="pgwSlider owl-carousel owl-theme">
				    ...
				    <li><img src="../<?php echo $single_image; ?>" alt="<?php echo $single_image; ?>"></li>
				...
				<div class="tsp-price-hotel-item col-md-3 col-sm-3 col-xs-12">
					<a href="room-booking.php?id=<?php echo $single_room->id; ?>"><button>BOOK NOW</button></a>
				</div>
			</div>
		</div><!--row-->
	</div>
				...
				<section class="tsp-nav-hotel-detail">
					<div class="container">
						<h2>All abouts the Rooms</h2>
						<ul class="nav nav-tabs">
							<li class="active"><a data-toggle="tab" href="hotel-details.php#home">ABOUT THE ROOM</a></li>
							<li><a data-toggle="tab" href="hotel-details.php#menu1">AVAILABILITY</a></li>
							<li><a data-toggle="tab" href="hotel-details.php#menu2">RELATED ROOMS</a></li>
						</ul>
									...
									<div class="row">
										<div class="tsp-content-hotel-detail tsp-box-hotel-content">
											...
											<div class="tsp-content">
												<?php echo $single_room->room_details; ?></div>
										</div>
									</div>
								</div></div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 tsp-footer-option tsp-no-padding-left">
					<aside class="tsp-widget-footer">
						...
						<div class="tsp-content-item">
							<p>You love to travel, and we love to help make travel one of life’s greatest pleasures. That’s why millions of consumers search for and book a wide range of Rooms, flights, car rentals, cruises, vacation packages and destination activities with us.</p>
